...
import com.amway.core.constants.AmwaycommercewebservicesaddonConstants;



/**
 * This is the extension manager of the amwaycommercewebservicesaddon extension.
 */
public class AmwaycommercewebservicesaddonManager extends GeneratedAmwaycommercewebservicesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AmwaycommercewebservicesaddonManager.class.getName());
	 ...
	 */
	public AmwaycommercewebservicesaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmwaycommercewebservicesaddonManager called.");
		}
	}
	 ...
	 */
	public static AmwaycommercewebservicesaddonManager getInstance()
	{
		return (AmwaycommercewebservicesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwaycommercewebservicesaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmwaycommercewebservicesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmwaycommercewebservicesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}

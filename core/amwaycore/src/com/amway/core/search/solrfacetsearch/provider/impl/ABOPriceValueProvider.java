...
/**
 * This class will provide the value of ABO Price Value to Solr
 */
public class ABOPriceValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	private static final Logger LOG = Logger.getLogger(ABOPriceValueProvider.class);

 ...
 *  
 */
package com.amway.core.suggestion.dao;
 ...
 * {@link com.amway.core.suggestion.SimpleSuggestionService}.
 */
public interface SimpleSuggestionDao extends Dao
{
	 ...
	 *
	 * @param category         the category that the returned products must belong to
	 * @param user             the user that has placed the orders
	 * @param referenceTypes   optional referenceTypes
	 * @param excludePurchased if true, only retrieve products that have not been purchased by the user
	 ...
	 *
	 * @param products         the products that the returned products must belong to
	 * @param user             the user that has placed the orders
	 * @param referenceTypes   optional referenceTypes
	 * @param excludePurchased if true, only retrieve products that have not been purchased by the user
	 * @param limit            if not null: limit the amount of returned products to the given number

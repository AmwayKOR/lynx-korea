...
public class DefaultLosBonusAdjustmentServiceTest extends ServicelayerTransactionalTest
{
	...
	private MockOrderBonusService defaultLosBonusAdjustmentService;
	...
	@Test
	public void shouldGetLosBonusAdjustmentServiceTest()
	{
		final BonusOrderResultData responce = defaultLosBonusAdjustmentService.process(bonusRequestData);

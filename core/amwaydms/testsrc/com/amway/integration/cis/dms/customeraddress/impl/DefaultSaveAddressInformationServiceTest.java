...
import com.amway.integration.cis.dms.customeraddress.mock.impl.MockSaveAddressInformationImpl;
import com.hybris.cis.common.utils.StringUtils;


@UnitTest
public class DefaultSaveAddressInformationServiceTest extends ServicelayerTest
{
	...
	@Resource(name = "mockSaveAddressInformationService")
	private MockSaveAddressInformationImpl defaultSaveAddressInformationService;
	...
	@Test
	public void shouldSaveAddressInformation()
	{
		final CommonResponseFieldsData response = defaultSaveAddressInformationService.process(requestData);

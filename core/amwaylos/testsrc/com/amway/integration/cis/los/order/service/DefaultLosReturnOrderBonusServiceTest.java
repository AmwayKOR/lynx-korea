...
public class DefaultLosReturnOrderBonusServiceTest extends ServicelayerTest
{
	...
	private MockOrderBonusService defaultLosOrderBonusService;
	...
	@Test
	public void shouldReturnLosOrderBonusTest()
	{
		final BonusOrderResultData responce = defaultLosOrderBonusService.process(bonusRequestData);

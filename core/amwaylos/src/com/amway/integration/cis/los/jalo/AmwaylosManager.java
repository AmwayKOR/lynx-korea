 ...
 *  
 */
package com.amway.integration.cis.los.jalo;
...
import com.amway.integration.cis.los.constants.AmwaylosConstants;



/**
 * This is the extension manager of the Amwaylos extension.
 */
public class AmwaylosManager extends GeneratedAmwaylosManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(AmwaylosManager.class.getName());
	 ...
	 */
	public static AmwaylosManager getInstance()
	{
		return (AmwaylosManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwaylosConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmwaylosManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmwaylosManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmwaylosManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmwaylosManager called, current tenant: " + getTenant().getTenantID());
		}
	}

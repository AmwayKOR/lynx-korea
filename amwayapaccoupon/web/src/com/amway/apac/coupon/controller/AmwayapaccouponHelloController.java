 ...
 */
package com.amway.apac.coupon.controller;
...
@Controller
public class AmwayapaccouponHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", amwayapaccouponService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}

 ...
 */
public class AmwayApacProductReferenceServiceImpl  extends DefaultCommerceProductReferenceService
        implements AmwayApacProductReferenceService<ProductReferenceTypeEnum, ProductModel> {

    private static final Logger LOG = Logger.getLogger(AmwayApacProductReferenceServiceImpl.class);
     ...
     * @return
     */
    private List<AmwayCategoryProductReferenceModel> getAllActiveCategoryProductReferencesFromSourceOfType(
     ...
     * @return
     */
    private Collection<AmwayCategoryProductReferenceModel> getProductReferencesForCategory(final CategoryModel category)
    {
     ...
     */
    private Object getCategoryAttribute(final CategoryModel category, final String attribute)
    {

...
public class AmwayBusinessEventBuilder
{
	...
	public AmwayBusinessEventBuilder(final AbstractOrderModel abstractOrderModel)
	{
		event = new AmwayBusinessEvent();
		defaultInit();
		consumeOrderInfo(abstractOrderModel);
	}
	...
	protected void consumeOrderInfo(final AbstractOrderModel orderModel)
	{
		setEntityId(orderModel.getCode());
	...
	public AmwayBusinessEventBuilder setEntityName(final EntityName entityName)
	{
		event.setEntityName(entityName.value);
		return this;
	}

	public AmwayBusinessEventBuilder setEventName(final EventName eventName)
	{
	...
	public AmwayBusinessEventBuilder setTrigger(final Trigger trigger)
	{
		event.setTriggeredBy(trigger.value);
		return this;
	}

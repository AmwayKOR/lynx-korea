...
import com.amway.core.v2.helper.StoresHelper;
...
public class StoresController extends BaseController
{
	...
	/**
	 * Returns {@value com.amway.core.v2.controller.BaseController#HEADER_TOTAL_COUNT} header with the number of all store locations that are near the

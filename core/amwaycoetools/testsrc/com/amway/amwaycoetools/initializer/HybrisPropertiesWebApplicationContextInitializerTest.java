 ...
 */
package com.amway.amwaycoetools.initializer;
...
{ AmwaycoetoolsConstants.EXTENSIONNAME, "oauth2" })
public class HybrisPropertiesWebApplicationContextInitializerTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		wsSecuredRequestBuilder = new WsSecuredRequestBuilder()//
				.extensionName(AmwaycoetoolsConstants.EXTENSIONNAME)//
				.client(OAUTH_CLIENT_ID, OAUTH_CLIENT_PASS);

		createCoreData();
		importCsv("/amwaycoetools/test/democustomer-data.impex", "utf-8");
	}

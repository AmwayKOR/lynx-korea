...
/**
 * Unit test for {@link AmwayApacWishlistPopulator}
 *
 * @author avnishalaugh
 *
 */
...
public class AmwayApacWishlistPopulatorUnitTest
{
	/**
	 ...
	 */
	@InjectMocks
	private final AmwayApacWishlistPopulator amwayApacWishlistPopulator = new AmwayApacWishlistPopulator();
	...
	public void prepare()
	{
		...
		BDDMockito.when(wishlistModel.getModifiedtime()).thenReturn(WISHLIST_LASTUPDATED);
		BDDMockito.when(wishlistModel.getCreationtime()).thenReturn(WISHLIST_CREATIONTIME);

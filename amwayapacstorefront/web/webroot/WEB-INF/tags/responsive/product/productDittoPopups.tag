...
<div id="added-to-ditto-wrapper">
	<div class="cbox cboxAddToYourDitto">
		<div class="cart-popup__dialog">
			<div class="cart-popup__header">
				<span class="cart-popup__header-text">
					added to your ditto
					<img class="cart-popup__close" src="${themeResourcePath}/images/close.png" alt="close" data-dismiss="modal" aria-label="Close"
						aria-hidden="true">
				</span>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-8 form-opera">
								...
								<div class="search-contacts">
									<img src="${themeResourcePath}/images/add_new_people.png">

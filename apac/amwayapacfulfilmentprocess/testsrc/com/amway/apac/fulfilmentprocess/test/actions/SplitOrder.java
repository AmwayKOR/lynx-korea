 ...
 */
package com.amway.apac.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AmwayapacFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AmwayapacFulfilmentProcessConstants.PARENT_PROCESS);

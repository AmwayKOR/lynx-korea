 ...
 */
package com.amway.core.oauth2.jalo;
...
/**
 * This is the extension manager of the Amwayoauth2 extension.
 */
public class Amwayoauth2Manager extends GeneratedAmwayoauth2Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Amwayoauth2Manager.class);
	 ...
	 */
	public static Amwayoauth2Manager getInstance()
	{
		return (Amwayoauth2Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Amwayoauth2Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public Amwayoauth2Manager() // NOPMD 
	{
		LOG.debug("constructor of Amwayoauth2Manager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Amwayoauth2Manager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Amwayoauth2Manager called, current tenant: {}", getTenant().getTenantID());
	}

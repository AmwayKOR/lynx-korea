...
import com.amway.apac.backoffice.renderers.BackOrderEssentialsRenderer;
...
public class BackOrderEssentialsRendererTest
{
	...
	@InjectMocks
	private BackOrderEssentialsRenderer backOrderEssentialsRenderer;
	...
	public void setUp() throws Exception
	{
		...
		when(amwayBackOrderModel.getStatus()).thenReturn(amwayBackOrderStatus.ACTIVE);
		userModel.setUid("user1");
		when(amwayBackOrderModel.getOrderingAbo()).thenReturn(userModel);
	...
	{
		backOrderEssentialsRenderer.render(parent, configuration, data, dataType, widgetInstanceManager);

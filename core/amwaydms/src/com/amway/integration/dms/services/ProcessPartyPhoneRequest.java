...
/**
 * <p>Java class for processPartyPhoneRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="processPartyPhoneRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="phoneDataList" type="{}phoneData" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "processPartyPhoneRequest", propOrder = {
    "aboNum",
    "partyId",
    "phoneDataList",
    "salesPlanAff"
...
public class ProcessPartyPhoneRequest
    extends BaseWebServiceInput
{
    ...
    protected List<PhoneData> phoneDataList;
    ...
    /**
     * Gets the value of the phoneDataList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the phoneDataList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPhoneDataList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<PhoneData> getPhoneDataList() {
        if (phoneDataList == null) {
            phoneDataList = new ArrayList<PhoneData>();
        }

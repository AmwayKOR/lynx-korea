...
public class DefaultAmwayApacNotificationFacadeIntegrationTest extends ServicelayerTransactionalTest
{
	...
	/**
	 * Integration test method of Message Center for detailed message component
	 */
	@Test
	public void testGetDetailedMessage()
	{
		CMSParagraphComponentModel messageComponent = null;
		final String compId = "group_notification";
		try
		{
			messageComponent = defaultAmwayApacNotificationFacade.getDetailedMessage(compId);
		}
		...
		Assert.assertEquals(compId, messageComponent.getUid());
		Assert.assertEquals("TestGroupNotification", messageComponent.getContent());
	}

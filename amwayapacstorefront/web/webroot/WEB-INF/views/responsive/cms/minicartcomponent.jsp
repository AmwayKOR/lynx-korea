		...
		<div class="nav-cart nav-cart-wrapper js-nav-cart-wrapper print-hide">
			<c:choose>
				<c:when test="${isUserAbo}">
					<a href="javascript:void(0);" class="pos-relative mini-cart-link js-mini-cart-link clearfix is-abo"
						data-target="#shoppingcar-drop-content" data-mini-cart-url="${miniCartUrl}"
				...
				<c:otherwise>
					<a href="#" class="pos-relative mini-cart-link clearfix" data-target="#shoppingcar-drop-content">
						<div class="mini-cart-icon">
							<span class="icon-shopping-cart"></span>
						</div>
						<div class="cart-icon-wrapper">

...
import com.amway.integration.cis.dms.partypreferenceservice.mock.impl.MockAddPartyPreferenceService;


/**
 * @author admin
 */
public class DefaultAddPartyPreferenceServiceTest extends ServicelayerTransactionalTest
{
	@Resource(name = "mockAddPartyPreferenceService")
	private MockAddPartyPreferenceService defaultAddPartyPreferenceService;
	...
	@Test
	public void shouldGetDmsAddPartyPreferenceTest()
	{
		final CommonResponseFieldsData response = defaultAddPartyPreferenceService.process(partyPreferenceData);

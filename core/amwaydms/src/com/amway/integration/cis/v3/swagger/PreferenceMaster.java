...
public class PreferenceMaster   {
  ...
  @SerializedName("preferenceCatagoryTypeId")
  ...
  public PreferenceMaster preferenceId(String preferenceId) {
   ...
   * @return preferenceId
  **/
  @ApiModelProperty(example = "null", value = "<a href='/DMS_Service_Web/DomainCodeLookUp.jsp?code=PRFID'>Reference to Preference codes</a>")
  ...
  public PreferenceMaster isTrueFlg(String isTrueFlg) {
  ...
  **/
  ...
  public PreferenceMaster choiceListFlg(String choiceListFlg) {
  ...
  **/
  ...
  public PreferenceMaster preferenceNote(String preferenceNote) {
  ...
  **/
  ...
  public PreferenceMaster preferenceDesc(String preferenceDesc) {
  ...
  **/
  ...
  public PreferenceMaster preferenceCatagoryTypeId(String preferenceCatagoryTypeId) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "<a href='/DMS_Service_Web/DomainCodeLookUp.jsp?code=PREFS'>Reference to Preference Catagory codes</a>")
  ...
  public PreferenceMaster preferenceTypeList(List<PreferenceType> preferenceTypeList) {
    this.preferenceTypeList = preferenceTypeList;
    return this;
  }

  public PreferenceMaster addPreferenceTypeListItem(PreferenceType preferenceTypeListItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.preferenceId, preferenceMaster.preferenceId) &&
        Objects.equals(this.isTrueFlg, preferenceMaster.isTrueFlg) &&
        Objects.equals(this.choiceListFlg, preferenceMaster.choiceListFlg) &&
        Objects.equals(this.preferenceNote, preferenceMaster.preferenceNote) &&
        Objects.equals(this.preferenceDesc, preferenceMaster.preferenceDesc) &&
        Objects.equals(this.preferenceCatagoryTypeId, preferenceMaster.preferenceCatagoryTypeId) &&
        Objects.equals(this.preferenceTypeList, preferenceMaster.preferenceTypeList);
  }

 ...
 * Service for to add the party phone details.
 */
@Deprecated
public class DefaultAddPartyPhoneService
		...
		implements DmsService<PartyPhoneDetailsRequestData, CommonResponseFieldsData>
{
	...
	private static final Logger LOG = Logger.getLogger(DefaultAddPartyPhoneService.class);

	@Override
	protected ReturnInfoService executeEvent(final Object input)
	{
		LOG.info("Calling webservice PhoneService/addPartyPhone.....");
		...
		Assert.notNull(dmsResultRestResponse, "Failed to add party phone details");
	...
	protected CommonResponseFieldsData createDefaultResult()
	{
		...
		commonResponseFieldsData.setReturnMessage("Failed to add party phone details");

...
/**
 * Populator implementation for {@link AddressModel} as source and {@link AddressVerificationResultData} as target type.
 */
public class AmwayDMSAddressMatchingPopulator implements
...
{
	@Override
	public void populate(final AddressModel source,

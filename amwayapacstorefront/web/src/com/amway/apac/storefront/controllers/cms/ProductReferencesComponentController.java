...
import com.amway.apac.facades.product.impl.DefaultAmwayApacProductFacade;
		...
		extends AbstractAcceleratorCMSComponentController<ProductReferencesComponentModel>
{
	...
	private DefaultAmwayApacProductFacade productFacade;
										   ...
										   final ProductModel product)
	{
		if (null != product)
		{
			...
			final List<ProductData> productReferences = this.getProductFacade().getProductReferencesProductDataForCode(
					product.getCode(), component.getProductReferenceTypes(), component.getMaximumNumberProducts());
			...
			else
			{
				...
				LOG.info("Found no reference products for the product [{}]. Fetching reference products for the category [{}] of the product.", product.getCode(), categoryModel.getCode());
                                            ...
                                            final CategoryModel category)
    {
        if (category != null)
        {
            ...
            final List<ProductData> productReferences = getProductFacade().getCategoryProductReferencesForCode(category,
	...
	/**
	 * Gets the productFacade
	 * @return the productFacade
	 */
	public DefaultAmwayApacProductFacade getProductFacade() {
		return productFacade;
	}

	/**
	 * Sets the productFacade
	 * @param productFacade the productFacade
	 */
	public void setProductFacade(DefaultAmwayApacProductFacade productFacade) {

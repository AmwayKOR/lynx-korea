...
public class DefaultAmwayoauth2Service implements Amwayoauth2Service
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAmwayoauth2Service.class);
	...
	{
		return DefaultAmwayoauth2Service.class.getResourceAsStream("/amwayoauth2/sap-hybris-platform.png");
	}

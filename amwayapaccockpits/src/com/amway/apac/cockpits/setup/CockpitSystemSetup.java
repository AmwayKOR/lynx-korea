 ...
 */
package com.amway.apac.cockpits.setup;
...
import com.amway.apac.cockpits.constants.AmwayapacCockpitsConstants;
 ...
 */
@SystemSetup(extension = AmwayapacCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AmwayapacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AmwayapacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AmwayapacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/amwayapaccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}

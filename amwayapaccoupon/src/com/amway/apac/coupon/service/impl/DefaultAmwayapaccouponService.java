...
public class DefaultAmwayapaccouponService implements AmwayapaccouponService
{
	...
	{
		return DefaultAmwayapaccouponService.class.getResourceAsStream("/amwayapaccoupon/sap-hybris-platform.png");
	}

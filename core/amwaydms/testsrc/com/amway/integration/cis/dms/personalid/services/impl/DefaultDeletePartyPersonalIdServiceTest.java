 ...
 * @author SumitS
 */
public class DefaultDeletePartyPersonalIdServiceTest extends ServicelayerTest
{
	...
	@Resource(name = "mockAddPartyPersonalIdService")
	private CommonMockService defaultAddPartyPersonalIdService;
	...
	{
		final CommonResponseFieldsData responce = defaultAddPartyPersonalIdService.process(requestData);

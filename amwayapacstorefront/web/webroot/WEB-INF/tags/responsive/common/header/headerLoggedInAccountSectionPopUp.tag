	...
	<div class="popover-content">
		<ul class="nav__links account-popover js-my-account-popover">
			<li class="account-popover__congratulation">
				<div class="account">
					<div class="sys-message">
						...
						<span>
							<spring:theme code="text.header.logged.icon-caution" />
						</span>
					</div>
					<div class="sys-message">
						<div class="ico-wraper">
							<span class="message-num">
								<spring:theme code="text.header.logged.message-num" />
							</span>
						</div>
						<span>
							<spring:theme code="text.header.logged.message" />
						</span>
					</div>
				</div>
			</li>
			<li class="account-popover__scores">
				<ul>
					<li>
						<spring:theme code="text.header.logged.account-popover_scores" />
					</li>
					<li>
						<spring:theme code="text.header.logged.account-popover_scores.no" />
					</li>
				</ul>
				<p>
			...
			<li class="account-popover__element sign-out">
				...
				<a href="${logoutUrl}" title="Sign Out">
					...
					<spring:theme code="text.header.logged.signout" />
				</a>
			</li>
		</ul>
	</div>

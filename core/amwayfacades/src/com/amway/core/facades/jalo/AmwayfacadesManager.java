 ...
 *  
 */
package com.amway.core.facades.jalo;
...
import com.amway.core.facades.constants.AmwayfacadesConstants;



/**
 * This is the extension manager of the Amwayfacades extension.
 */
public class AmwayfacadesManager extends GeneratedAmwayfacadesManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(AmwayfacadesManager.class.getName());
	 ...
	 */
	public static AmwayfacadesManager getInstance()
	{
		return (AmwayfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwayfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmwayfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AmwayfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AmwayfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AmwayfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}

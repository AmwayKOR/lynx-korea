...
/**
 */
public abstract class RLAbstractContentSearchPageController extends AbstractPageController
{
			...
			final List<BreadcrumbData<SearchStateData>> breadcrumbs)
	{
		...
		for (final BreadcrumbData<SearchStateData> breadcrumb : breadcrumbs)
		{
			...
			final List<FacetValueData<SearchStateData>> facetValues =
					facet.getValues() != null ? new ArrayList<>(facet.getValues()) : new ArrayList<FacetValueData<SearchStateData>>();

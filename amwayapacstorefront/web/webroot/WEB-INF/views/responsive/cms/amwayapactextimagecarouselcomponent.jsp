...
<div class="full-width-item second-option">
		<div class="item-image-wrap">
			<a href="${cmsLinkUrl}" class="primary-link "> <img class="desktop-image"
				src="${component.backgroundImage.media.url}" alt="three tile"></a>
		</div>
		<div class="item-content-wrap">
			<div class="carousel-link-wrap">
				<a href="${cmsLinkUrl}" class="primary-link ">
				 <span>${component.headerText}</span></a>

...
public class DefaultAmwayperformanceService implements AmwayperformanceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAmwayperformanceService.class);
	...
	{
		return DefaultAmwayperformanceService.class.getResourceAsStream("/amwayperformance/sap-hybris-platform.png");
	}

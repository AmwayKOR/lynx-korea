 ...
 */
package com.amway.apac.test.setup;
...
import com.amway.apac.test.constants.AmwayapacTestConstants;
import com.amway.apac.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AmwayapacTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/amwayapactest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/amwayapactest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/amwayapactest/import/cstickets.impex");
			...
			importImpexFile(context, "/amwayapactest/import/csquotes.impex");
		}
	}
}

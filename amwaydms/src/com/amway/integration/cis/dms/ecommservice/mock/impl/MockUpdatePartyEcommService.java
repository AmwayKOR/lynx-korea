...
/**
 * Mock Service for to update the party ecomm details.
 */
public class MockUpdatePartyEcommService
		...
		implements DmsService<AddUpdatePartyEcommRequestData, CommonResponseFieldsData>
{
	...
	protected CommonResponseFieldsData createDefaultResult()
	{
		...
		responseData.setReturnMessage("Fail to updated Ecomm details for Party");
		return responseData;
	}

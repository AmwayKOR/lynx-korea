 ...
 *  
 */
package com.amway.facades.suggestion.impl;
...
public class DefaultSimpleSuggestionFacade implements SimpleSuggestionFacade
{
			...
			final List<ProductReferenceTypeEnum> referenceTypes, final boolean excludePurchased, final Integer limit)
	{
		...
		final List<ProductModel> suggestions = getSimpleSuggestionService()
				.getReferencesForPurchasedInCategory(category, referenceTypes, user, excludePurchased, limit);
			...
			final ProductReferenceTypeEnum referenceType, final boolean excludePurchased, final Integer limit)
	{
		...
		final List<ProductModel> suggestions = getSimpleSuggestionService()
				.getReferencesForPurchasedInCategory(category, user, referenceType, excludePurchased, limit);

...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/amwayapacstorefront/electronics/en",
						"https://electronics.local:9002/amwayapacstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/amwayapacstorefront/electronics/en",
						"https://electronics.local:9002/amwayapacstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/amwayapacstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/amwayapacstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/amwayapacstorefront/electronics/en",
						"https://electronics.local:9002/amwayapacstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/amwayapacstorefront",
						"https://electronics.local:9002/amwayapacstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/amwayapacstorefront",
						"https://electronics.local:9002/amwayapacstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/amwayapacstorefront/electronics/en",
						"https://electronics.local:9002/amwayapacstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

...
/**
 */
public class ContentCategorySearchPageConverter<QUERY, STATE, RESULT, ITEM extends ContentData, SCAT, CATEGORY> extends
		AbstractPopulatingConverter<ContentCategorySearchPageData<QUERY, RESULT, SCAT>, ContentCategorySearchPageData<STATE, ITEM, CATEGORY>>
{
	...
	@Override
	protected ContentCategorySearchPageData<STATE, ITEM, CATEGORY> createTarget()
	{
		return new ContentCategorySearchPageData<STATE, ITEM, CATEGORY>();
	}

	@Override
	public void populate(final ContentCategorySearchPageData<QUERY, RESULT, SCAT> source,
			final ContentCategorySearchPageData<STATE, ITEM, CATEGORY> target)
	{

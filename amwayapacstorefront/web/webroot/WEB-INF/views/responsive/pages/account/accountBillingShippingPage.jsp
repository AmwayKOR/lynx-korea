...
<div class="row">
            <div class="container">
                                                        ...
                                                        <div class="payment-info-container container-fluid">
                                                            <div id="" class="row">
                                                                <div class="col-xs-6 card-info-block">
                                                                    ...
                                                                    <div class="card-info">
                                                                        <div class="card-data">
                                                                            <span class="card-code">mastercard</span>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="help-block card-number-block">
                                                                                <input type="text" id="card-number"
                                                                                    ...
                                                                                    value="mastercard ending in 0008"
                                                                                    style=""/>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="help-block expiry-block">
                                                                                <input type="text" id="expiry-month"
                                                                                    class="text form-control" value="11"/>
                                                                            ...
                                                                            <div class="help-block expiry-block">
                                                                                <input type="text" id="expiry-year"
                                                                                    class="text form-control" value="22"/>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label "
                                                                                    ...
                                                                                    1</label>
                                                                                <input id="mailingAddressLine1" name="addressLine1" class="text form-control" value="489 Friendship Lane  Oakland, CA  "/>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="control-label "
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input id="mailingAddressPostalCode"
                                                                                    ...
                                                                                    class="text form-control" value=" 94612"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="panel-heading" role="tab" id="billingShipping">
                                    <h4 class="panel-title">
                                        <div role="button" class="collapsed" data-toggle="collapse"
                                            ...
                                            <span class="text-uppercase panel-title-text">Billing &amp; shipping addresses</span>
                                            <span class="indicator pull-right"></span>
                                        </div>
                                    </h4>
                                </div>
                                        ...
                                        <div class="primary-address-section container-fluid">
                                            ...
                                            <div class="main row">
                                                <div class="address-container col-xs-12 col-md-6">
                                                    <div id="address-view-8796093218839_unique" class="">
                                                        <div class="form-container">
                                                            <div class="mailing-address">
                                                                <span class="primary-text mailing-address__title">Shipping address</span>
                                                                <span class="secondary-text mailing-address__line-one">489 Friendship Lane</span>
                                                                <span class="secondary-text mailing-address__city">Oakland</span>
                                                                <div>
                                                                    California
                                                                </div>
                                                                <span class="secondary-text mailing-address__zip">94612</span>
                                                                <button type="button"
                                                                        class="btn-edit btn btn-primary"
                                                                        data-address-id="8796093218839_unique"> Edit
                                                                </button>
                                                            </div>
                                                            <div class="mailing-address-edit">
                                                                ...
                                                                <form action="" method="post" name="editAddress">
                                                                    <fieldset>
                                                                        <div class="form-group">
                                                                            <label for="cardNumber">ADDRESS NAME</label>
                                                                            <input name="cardNumber" class="form-control" type="text" value="Roman  Kotenko"></div>

                                                                        <div class="form-group">
                                                                            <label for="address1">ADDRESS LINE 1</label>
                                                                            <input name="address1" class="form-control" type="text" value="4940 Eastern Ave"></div>
                                                                        <div class="form-group">
                                                                            <label for="address2">ADDRESS LINE 2</label>
                                                                            <input name="address2" class="form-control" type="text" value="Baltimore">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="city">CITY/STATE</label>
                                                                            <input name="city" class="form-control form-city" type="text" value="Maryland">
                                                                            <select  id="place" class="prw-jump-to-selection select2-hidden-accessible" tabindex="-3" aria-hidden="true">
                                                                                <option>DC</option>
                                                                                <option>DE</option>
                                                                                <option>FL</option>
                                                                                <option>GA</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input name="ZIP" class="form-control" type="text" value="21224">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="tel">PHONE</label>
                                                                            <select  id="area" class="prw-jump-to-selection select2-hidden-accessible" tabindex="-3" aria-hidden="true">
                                                                                <option>US(1)</option>
                                                                                <option>HT(509)</option>
                                                                                <option>DO(1809)</option>
                                                                                <option>GA(1)</option>
                                                                            </select>
                                                                            <input name="tel2" class="form-control phone-area-1" type="text" value="123">
                                                                            <input name="tel3" class="form-control phone-area-2" type="text" value="111111">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="mail">EMAIL</label>
                                                                            <input name="tel" class="form-control" type="text" value="eee@gmail.com">
                                                                        </div>
                                                                        <input class="" id="edit1" name="edit1" type="checkbox">
                                                                        <label class="" for="edit1">Override address</label>
                                                                        <button type="button" class="btn-save btn btn-primary" data-address-id="">SAVE</button>
                ...
                <span class="display-none"> <input id="shippingAddress_8796093218839" name="defaultShippingAddress"
                                                    value="true" type="hidden"/>
                <div class="form-group">
                    <div class="checkbox">
                    <label class="control-label add-address-left-label"> <input id="mailingAddress_8796093218839"
                            ...
                            class="mandatory"> </span> <span class="skip"></span> </label>
                                                ...
                                                <div class="address-container col-xs-12 col-md-6">
                                                    <div id="address-view-8796093218839" class="">
                                                        <div class="form-container">
                                                            <div class="mailing-address">
                                                                <span class="primary-text mailing-address__title">Mailing address</span>
                                                                <span class="secondary-text mailing-address__line-one">489 Friendship Lane</span>
                                                                <span class="secondary-text mailing-address__city">Oakland</span>
                                                                <div>
                                                                    California
                                                                ...
                                                                <button type="button"
                                                                        class="btn-edit btn btn-primary"
                                                                        data-address-id="8796093218839"> Edit
                                                                </button>
                                                            </div>
                                                            <div class="mailing-address-edit">
                                                    ...
                                                    <div id="address-form-8796093218839"
                                                        class="form-container display-none">
                                                        <div id="validationErrorMsgCreateAddressForm" class="display-none">
                                                            The Address can't be validated. Please try again.
                                                        </div>
                                                        <form id="addressForm-8796093218839_mailing" class="new-address"
                                                            action="" method="post">
                                                            <div id="externalValidationErrorMessage"></div>
                                                            <span class="primary-text">Mailing address</span>
                                                            <input id="addressName" name="addressName" type="hidden"
                                                                value=""/>
                                                            <input id="addressId" name="addressId" value="8796093218839"
                                                                type="hidden"/>
                                                            ...
                                                            <input id="skipAdditionalFields" name="skipAdditionalFields"
                                                                value="true" type="hidden"/>
                                                            <input id="taxJurisdictionCode-8796093218839_mailing"
                                                                name="taxJurisdictionCode" type="hidden" value=""/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line1"> Address
                                                                    Line 1</label>
                                                            ...
                                                            <input type="hidden" name="isDittoRelatedAddress"
                                                                id="isDittoRelatedAddress" value="true"/>
                                                            <div class="checkbox-container edit-address-checkbox-container">
                                                                <span class="display-none"> <input
                                                                        id="defaultMailingAddress"
                                                                        name="defaultMailingAddress" value="true"
                                                                        type="hidden"/></span>
                                                            </div>
                                                            <div>
                                                                <input type="hidden" name="CSRFToken"
                                                        ...
                                                        <div class="hidden">
                                                            <div id="selectTaxJurisdictionBlockId-8796093218839_mailing"
                                                                data-popup-title="Choose the selection">
                                                                <div class="amway-theme js-tax-jurisdiction-block-content tax-juristiction-select-modal-container">
                                                                    <div class="tax-juristiction-container">
                                                                        <div class="tax-juristiction-message">
                                                                        ...
                                                                        <div class="table-header-container">
                                                                            <label>Tax jurisdiction for:</label>
                                                                            <span id="streetLine1-8796093218839_mailing"> </span>
                                                                        </div>
                                                                        <table class="tax-juristiction-table">
                                                                            <thead>
                                                                            <tr>
                                        ...
                                        <div class="alternative-address-section container-fluid">
                                            <div class="header">
                                                <span class="primary-text"> Alternative addresses</span>
                                            </div>
                                            <div class="main row">
                                                <div class="address-container col-xs-12 col-md-6">
                                                    ...
                                                    <div class="display-none">
                                                        <div id="confirm_popup_address_removal_8796486336535"
                                                            class="account-address-removal-popup">
                                                            <div class="addressItem">
                                                                The following address will be deleted
                                                                <div class="address">
                                                                    <strong> </strong>
                                                                    <br/> 4940 Eastern Ave&nbsp;
                                                                ...
                                                                <div class="modal-actions">
                                                                    <div class="row">
                                                                        <div class="col-xs-12 col-sm-6 col-sm-push-6">
                                                                            ...
                                                                            data-address-id="8796486336535" href="">
                                                                                Delete</a>
                                                                        </div>
                                                                        <div class="col-xs-12 col-sm-6 col-sm-pull-6">
                                                                            <a class="btn btn-default btn-block closeColorBox"
                                                                            data-address-id="8796486336535"> Cancel</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="address-form-8796486336535"
                                                        class="form-container display-none">
                                                        <div id="validationErrorMsgCreateAddressForm" class="display-none">
                                                            The Address can't be validated. Please try again.
                                                        </div>
                                                        <form id="addressForm-8796486336535_" class="new-address" action=""
                                                            method="post">
                                                            <div id="externalValidationErrorMessage"></div>
                                                            <div class="form-group">
                                                            ...
                                                            <input id="addressId" name="addressId" value="8796486336535"
                                                                type="hidden"/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.fullName"> Full
                                                                    Name</label>
                                                                <input id="address.fullName" name="fullName"
                                                                    class="text form-control" value="Roman Kotenko"
                                                                    maxlength="256"/>
                                                            </div>
                                                            <input id="taxJurisdictionCode-8796486336535_"
                                                                name="taxJurisdictionCode" type="hidden" value=""/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line1"> Address
                                                                    Line 1</label>
                                                                <input id="address.line1" name="line1"
                                                                    class="text form-control" minlength="1"
                                                                    value="4940 Eastern Ave" maxlength="70"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line2"> Address
                                                                    Line 2</label>
                                                            ...
                                                            <div class="amway-theme">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="address.townCity" name="townCity"
                                                                        class="form-control" min="1" max="70"
                                                                        mandatory="true" type="text" value="Baltimore"/>
                                                                    <select id="address.region" name="regionIso"
                                                                            tabindex="-1" class="select2-hidden-accessible"
                                                                            aria-hidden="true">
                                                                        <option title="name" value="US-AL">AL</option>
                                                                        ...
                                                                        <option title="name" value="US-AZ">AZ</option>
                                                                        <option title="name" value="US-AR">AR</option>
                                                                        <option title="name" value="US-CA">CA</option>
                                                                        <option title="name" value="US-CO">CO</option>
                                                                        <option title="name" value="US-CT">CT</option>
                                                                        <option title="name" value="US-DE">DE</option>
                                                                        <option title="name" value="US-DC">DC</option>
                                                                        ...
                                                                        <option title="name" value="US-LA">LA</option>
                                                                        <option title="name" value="US-ME">ME</option>
                                                                        <option title="name" selected="true" value="US-MD">
                                                                            MD
                                                                        </option>
                                                                        <option title="name" value="US-MA">MA</option>
                                                                        <option title="name" value="US-MI">MI</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.postcode">
                                                                    zip</label>
                                                                <input id="address.postcode" name="postcode"
                                                                    class="text form-control" minlength="1" value="21224"
                                                                    maxlength="20"/>
                                                            </div>
                                                                    ...
                                                                    <div class="value-part-1 col-md-3 col-sm-4">
                                                                        <div class="control-group">
                                                                            <select id="address.phoneCountryCode"
                                                                                ...
                                                                                <option value="1" selected="selected">CA
                                                                                    (1)
                                                                                </option>
                                                                                <option value="509">HT (509)</option>
                                                                                <option value="1" selected="selected">US
                                                                                    (1)
                                                                                </option>
                                                                    ...
                                                                    <div class="value-part-2 col-md-3 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="address.phoneAreaCode"
                                                                                name="phoneAreaCode"
                                                                                class="text form-control" minlength="1"
                                                                                type="number" value="410" maxlength="3"/>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="address.email" name="email"
                                                                    class="text form-control" minlength="1"
                                                                    value="eee@gmail.com" maxlength="254"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label class="control-label "> <input
                ...
                <div class="form-group">
                    <div class="checkbox">
                    <label class="control-label add-address-left-label"> <input id="shippingAddress_8796486336535"
                                                                                name="defaultShippingAddress"
                                                                                class="add-address-left-input  _checkbox-element-global-class"
                                                                                type="checkbox" value="true"/><input
                            type="hidden" name="_defaultShippingAddress" value="on"/><span
                            class="_checkbox-element-global-span"></span> <span
                            class="checkbox-text _checkbox-element-global-text"> Make Primary Shipping Address</span> <span
                            class="mandatory"> </span> <span class="skip"></span> </label>
                    </div>
                </div> <input id="shippingAddress" name="shippingAddress" value="true" type="hidden"/><input
                        id="defaultMailingAddress" name="defaultMailingAddress" value="false" type="hidden"/></span>
                                                            </div>
                                                            <div>
                                                                <input type="hidden" name="CSRFToken"
                                                                    value="f6eebe09-194d-436f-a044-29dc566efe76"/>
                                                        ...
                                                        <div class="hidden">
                                                            <div id="selectTaxJurisdictionBlockId-8796486336535_"
                                                                data-popup-title="Choose the selection">
                                                                <div class="amway-theme js-tax-jurisdiction-block-content tax-juristiction-select-modal-container">
                                                                    <div class="tax-juristiction-container">
                                                                        <div class="tax-juristiction-message">
                                                                        ...
                                                                        <div class="table-header-container">
                                                                            <label>Tax jurisdiction for:</label>
                                                                            <span id="streetLine1-8796486336535_"> </span>
                                                                        </div>
                                                                        <table class="tax-juristiction-table">
                                                                            <thead>
                                                                            <tr>
                                                ...
                                                <div class="address-container col-xs-12 col-md-6">
                                                    <div id="address-view-8796486369303" class="js-address-wrapper">
                                                        <div class="form-container">
                                                            <div class="mailing-address">
                                                                <span class="secondary-text mailing-address__full-name"> Roman &nbsp;Kotenko</span>
                                                                <span class="secondary-text mailing-address__line-one">7839 Eastern Ave, F5 Eastpoint Mall</span>
                                                                <span class="secondary-text mailing-address__city">Baltimore</span>
                                                                <div>
                                                                    Maryland
                                                                </div>
                                                                <span class="secondary-text mailing-address__zip">21224</span>
                                                                <span class="secondary-text mailing-address__phone">(1) 410-2841599</span>
                                                                <span class="secondary-text mailing-address__email">www@gmail.com</span>
                                                                <button type="button"
                                                                        class="btn-edit btn btn-primary"
                                                                        data-address-id="8796486369303"> Edit
                                                                </button>
                                                                <div href="#"
                                                                    class="action-links js-remove-address-with-popup-btn"
                                                                    data-address-id="8796486369303"
                                                                    data-popup-title="Delete Address">
                                                                    <span class="remove-button">Delete</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="display-none">
                                                        <div id="confirm_popup_address_removal_8796486369303"
                                                            class="account-address-removal-popup">
                                                            <div class="addressItem">
                                                                The following address will be deleted
                                                                <div class="address">
                                                                    <strong> </strong>
                                                                    <br/> 7839 Eastern Ave, F5 Eastpoint Mall&nbsp;
                                                                    <br/> Baltimore&nbsp; Maryland&nbsp;
                                                                    <br/> 21224
                                                                    <br/> (1) 410-2841599
                                                                </div>
                                                                <div class="modal-actions">
                                                                    <div class="row">
                                                                        <div class="col-xs-12 col-sm-6 col-sm-push-6">
                                                                            <a class="btn btn-primary btn-block"
                                                                            data-address-id="8796486369303" href="">
                                                                                Delete</a>
                                                                        </div>
                                                                        <div class="col-xs-12 col-sm-6 col-sm-pull-6">
                                                                            <a class="btn btn-default btn-block closeColorBox"
                                                                            data-address-id="8796486369303"> Cancel</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="address-form-8796486369303"
                                                        class="form-container display-none">
                                                        <div id="validationErrorMsgCreateAddressForm" class="display-none">
                                                            The Address can't be validated. Please try again.
                                                        </div>
                                                        <form id="addressForm-8796486369303_" class="new-address" action=""
                                                            method="post">
                                                            <div id="externalValidationErrorMessage"></div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.addressName">
                                                            ...
                                                            <input id="addressId" name="addressId" value="8796486369303"
                                                                type="hidden"/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.fullName"> Full
                                                                    Name</label>
                                                            ...
                                                            <input id="taxJurisdictionCode-8796486369303_"
                                                                name="taxJurisdictionCode" type="hidden" value=""/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line1"> Address
                                                                    Line 1</label>
                                                                <input id="address.line1" name="line1"
                                                                    class="text form-control" minlength="1"
                                                                    value="7839 Eastern Ave, F5 Eastpoint Mall"
                                                                    maxlength="70"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line2"> Address
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="address.email" name="email"
                                                                    class="text form-control" minlength="1"
                                                                    value="www@gmail.com" maxlength="254"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label class="control-label "> <input
                ...
                <div class="form-group">
                    <div class="checkbox">
                    <label class="control-label add-address-left-label"> <input id="shippingAddress_8796486369303"
                                                                                name="defaultShippingAddress"
                                                                                class="add-address-left-input  _checkbox-element-global-class"
                                                                                type="checkbox" value="true"/><input
                            type="hidden" name="_defaultShippingAddress" value="on"/><span
                        ...
                        id="defaultMailingAddress" name="defaultMailingAddress" value="false" type="hidden"/></span>
                                                        ...
                                                        <div class="hidden">
                                                            <div id="selectTaxJurisdictionBlockId-8796486369303_"
                                                                data-popup-title="Choose the selection">
                                                                <div class="amway-theme js-tax-jurisdiction-block-content tax-juristiction-select-modal-container">
                                                                    <div class="tax-juristiction-container">
                                                                        <div class="tax-juristiction-message">
                                                                        ...
                                                                        <div class="table-header-container">
                                                                            <label>Tax jurisdiction for:</label>
                                                                            <span id="streetLine1-8796486369303_"> </span>
                                                                        </div>
                                                                        <table class="tax-juristiction-table">
                                                                            <thead>
                                                                            <tr>
                                                ...
                                                <div class="address-container col-xs-12 col-md-6">
                                                    <div id="address-view-8796486664215" class="js-address-wrapper">
                                                        <div class="form-container">
                                                            <div class="mailing-address">
                                                                <span class="secondary-text mailing-address__full-name"> FRET &nbsp;GERTY</span>
                                                                <span class="secondary-text mailing-address__line-one">731 Eastern Ave</span>
                                                                <span class="secondary-text mailing-address__city">Baltimore</span>
                                                                <div>
                                                                    Maryland
                                                                </div>
                                                                <span class="secondary-text mailing-address__zip">21202</span>
                                                                <span class="secondary-text mailing-address__phone">(1) 410-5477200</span>
                                                                <span class="secondary-text mailing-address__email">sd@ferty.com</span>
                                                                <button type="button"
                                                                        class="btn-edit btn btn-primary"
                                                                        data-address-id="8796486664215"> Edit
                                                                </button>
                                                                <div href="#"
                                                                    class="action-links js-remove-address-with-popup-btn"
                                                                    data-address-id="8796486664215"
                                                                    data-popup-title="Delete Address">
                                                                    <span class="remove-button">Delete</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="display-none">
                                                        <div id="confirm_popup_address_removal_8796486664215"
                                                            class="account-address-removal-popup">
                                                            <div class="addressItem">
                                                                The following address will be deleted
                                                                <div class="address">
                                                                ...
                                                                <div class="modal-actions">
                                                                    <div class="row">
                                                                        <div class="col-xs-12 col-sm-6 col-sm-push-6">
                                                                            <a class="btn btn-primary btn-block"
                                                                            data-address-id="8796486664215" href="">
                                                                                Delete</a>
                                                                        </div>
                                                                        <div class="col-xs-12 col-sm-6 col-sm-pull-6">
                                                                            <a class="btn btn-default btn-block closeColorBox"
                                                                            data-address-id="8796486664215"> Cancel</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="address-form-8796486664215"
                                                        class="form-container display-none">
                                                        <div id="validationErrorMsgCreateAddressForm" class="display-none">
                                                            The Address can't be validated. Please try again.
                                                        </div>
                                                        <form id="addressForm-8796486664215_" class="new-address" action=""
                                                            method="post">
                                                            <div id="externalValidationErrorMessage"></div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.addressName">
                                                            ...
                                                            <input id="addressId" name="addressId" value="8796486664215"
                                                                type="hidden"/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.fullName"> Full
                                                                    Name</label>
                                                                <input id="address.fullName" name="fullName"
                                                                    class="text form-control" value="FRET GERTY"
                                                                    maxlength="256"/>
                                                            </div>
                                                            <input id="taxJurisdictionCode-8796486664215_"
                                                                name="taxJurisdictionCode" type="hidden" value=""/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line1"> Address
                                                                    Line 1</label>
                                                                <input id="address.line1" name="line1"
                                                                    class="text form-control" minlength="1"
                                                                    value="731 Eastern Ave" maxlength="70"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line2"> Address
                                                                    Line 2</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.postcode">
                                                                    zip</label>
                                                                <input id="address.postcode" name="postcode"
                                                                    class="text form-control" minlength="1" value="21202"
                                                                    maxlength="20"/>
                                                            </div>
                                                            <div class="form-group row phone-form-field-container">
                                                                <label class="control-label col-md-4"> Phone</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="address.email" name="email"
                                                                    class="text form-control" minlength="1"
                                                                    value="sd@ferty.com" maxlength="254"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label class="control-label "> <input
                                                            ...
                                                            <div class="edit-address-button-submit">
                ...
                <div class="form-group">
                    <div class="checkbox">
                    <label class="control-label add-address-left-label"> <input id="shippingAddress_8796486664215"
                                                                                name="defaultShippingAddress"
                                                                                class="add-address-left-input  _checkbox-element-global-class"
                                                                                type="checkbox" value="true"/><input
                            type="hidden" name="_defaultShippingAddress" value="on"/><span
                        ...
                        id="defaultMailingAddress" name="defaultMailingAddress" value="false" type="hidden"/></span>
                                                        ...
                                                        <div class="hidden">
                                                            <div id="selectTaxJurisdictionBlockId-8796486664215_"
                                                                data-popup-title="Choose the selection">
                                                                <div class="amway-theme js-tax-jurisdiction-block-content tax-juristiction-select-modal-container">
                                                                    <div class="tax-juristiction-container">
                                                                        <div class="tax-juristiction-message">
                                                                        ...
                                                                        <div class="table-header-container">
                                                                            <label>Tax jurisdiction for:</label>
                                                                            <span id="streetLine1-8796486664215_"> </span>
                                                                        </div>
                                                                        <table class="tax-juristiction-table">
                                                                            <thead>
                                                                            <tr>
                                                ...
                                                <div class="address-container col-xs-12 col-md-6">
                                                    <div id="address-view-8796586639383" class="js-address-wrapper">
                                                        <div class="form-container">
                                                            <div class="mailing-address">
                                                                <span class="secondary-text mailing-address__full-name"> Fsxa &nbsp;ADa</span>
                                                                <span class="secondary-text mailing-address__line-one">asx</span>
                                                                <span class="secondary-text mailing-address__line-two">asx</span>
                                                                <span class="secondary-text mailing-address__city">Los Angeles</span>
                                                                <div>
                                                                    California
                                                                </div>
                                                                <span class="secondary-text mailing-address__zip">90012</span>
                                                                <span class="secondary-text mailing-address__phone">(1) 123-1233</span>
                                                                <span class="secondary-text mailing-address__email">altaddress@gmail.com</span>
                                                                <button type="button"
                                                                        class="btn-edit btn btn-primary"
                                                                        data-address-id="8796586639383"> Edit
                                                                </button>
                                                                <div href="#"
                                                                    class="action-links js-remove-address-with-popup-btn"
                                                                    data-address-id="8796586639383"
                                                                    data-popup-title="Delete Address">
                                                                    <span class="remove-button">Delete</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="display-none">
                                                        <div id="confirm_popup_address_removal_8796586639383"
                                                            class="account-address-removal-popup">
                                                            <div class="addressItem">
                                                                The following address will be deleted
                                                                <div class="address">
                                                                ...
                                                                <div class="modal-actions">
                                                                    <div class="row">
                                                                        <div class="col-xs-12 col-sm-6 col-sm-push-6">
                                                                            <a class="btn btn-primary btn-block"
                                                                            data-address-id="8796586639383" href="">
                                                                                Delete</a>
                                                                        </div>
                                                                        <div class="col-xs-12 col-sm-6 col-sm-pull-6">
                                                                            <a class="btn btn-default btn-block closeColorBox"
                                                                            data-address-id="8796586639383"> Cancel</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="address-form-8796586639383"
                                                        class="form-container display-none">
                                                        <div id="validationErrorMsgCreateAddressForm" class="display-none">
                                                            The Address can't be validated. Please try again.
                                                        </div>
                                                        <form id="addressForm-8796586639383_" class="new-address" action=""
                                                            method="post">
                                                            <div id="externalValidationErrorMessage"></div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.addressName">
                                                            ...
                                                            <input id="addressId" name="addressId" value="8796586639383"
                                                                type="hidden"/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.fullName"> Full
                                                                    Name</label>
                                                                <input id="address.fullName" name="fullName"
                                                                    class="text form-control" value="Fsxa ADa"
                                                                    maxlength="256"/>
                                                            </div>
                                                            <input id="taxJurisdictionCode-8796586639383_"
                                                                name="taxJurisdictionCode" type="hidden" value=""/>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line1"> Address
                                                                    Line 1</label>
                                                                <input id="address.line1" name="line1"
                                                                    class="text form-control" minlength="1" value="asx"
                                                                    maxlength="70"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.line2"> Address
                                                                    Line 2</label>
                                                                <input id="address.line2" name="line2"
                                                                    class="text form-control" value="asx"
                                                                    maxlength="70"/>
                                                            </div>
                                                            <div class="amway-theme">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label " for="address.postcode">
                                                                    zip</label>
                                                                <input id="address.postcode" name="postcode"
                                                                    class="text form-control" minlength="1" value="90012"
                                                                    maxlength="20"/>
                                                            </div>
                                                            <div class="form-group row phone-form-field-container">
                                                                <label class="control-label col-md-4"> Phone</label>
                                                                    ...
                                                                    <div class="value-part-2 col-md-3 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="address.phoneAreaCode"
                                                                                name="phoneAreaCode"
                                                                                class="text form-control" minlength="1"
                                                                                type="number" value="123" maxlength="3"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="value-part-3 col-md-6 col-sm-4">
                                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="address.email" name="email"
                                                                    class="text form-control" minlength="1"
                                                                    value="altaddress@gmail.com" maxlength="254"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label class="control-label "> <input
                ...
                <div class="form-group">
                    <div class="checkbox">
                    <label class="control-label add-address-left-label"> <input id="shippingAddress_8796586639383"
                                                                                name="defaultShippingAddress"
                                                                                class="add-address-left-input  _checkbox-element-global-class"
                                                                                type="checkbox" value="true"/><input
                            type="hidden" name="_defaultShippingAddress" value="on"/><span
                        ...
                        id="defaultMailingAddress" name="defaultMailingAddress" value="false" type="hidden"/></span>
                                                        ...
                                                        <div class="hidden">
                                                            <div id="selectTaxJurisdictionBlockId-8796586639383_"
                                                                data-popup-title="Choose the selection">
                                                                <div class="amway-theme js-tax-jurisdiction-block-content tax-juristiction-select-modal-container">
                                                                    <div class="tax-juristiction-container">
                                                                        <div class="tax-juristiction-message">
                                                                        ...
                                                                        <div class="table-header-container">
                                                                            <label>Tax jurisdiction for:</label>
                                                                            <span id="streetLine1-8796586639383_"> </span>
                                                                        </div>
                                                                        <table class="tax-juristiction-table">
                                                                            <thead>
                                                                            <tr>

...
import com.amway.sso.constants.AmwayssoConstants;



/**
 * This is the extension manager of the Amwaysso extension.
 */
public class AmwayssoManager extends GeneratedAmwayssoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AmwayssoManager.class);
	 ...
	 */
	public static AmwayssoManager getInstance()
	{
		return (AmwayssoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwayssoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmwayssoManager() // NOPMD 
	{
		LOG.debug("constructor of AmwayssoManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AmwayssoManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AmwayssoManager called, current tenant: {}", getTenant().getTenantID());
	}

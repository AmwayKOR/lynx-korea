...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		processCockpit(context, importAccessRights, extensionNames, "cmscockpit",
				"/amwayapaccore/import/cockpits/cmscockpit/cmscockpit-users.impex",
				"/amwayapaccore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");

		processCockpit(context, importAccessRights, extensionNames, "productcockpit",
				"/amwayapaccore/import/cockpits/productcockpit/productcockpit-users.impex",
				"/amwayapaccore/import/cockpits/productcockpit/productcockpit-access-rights.impex",
				"/amwayapaccore/import/cockpits/productcockpit/productcockpit-constraints.impex");

		processCockpit(context, importAccessRights, extensionNames, "cscockpit",
				"/amwayapaccore/import/cockpits/cscockpit/cscockpit-users.impex",
				"/amwayapaccore/import/cockpits/cscockpit/cscockpit-access-rights.impex");

		processCockpit(context, importAccessRights, extensionNames, "reportcockpit",
				"/amwayapaccore/import/cockpits/reportcockpit/reportcockpit-users.impex",
				"/amwayapaccore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/amwayapaccore/import/common/mcc-sites-links.impex");
		}
	}

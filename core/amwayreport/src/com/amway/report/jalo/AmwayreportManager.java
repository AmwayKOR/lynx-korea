...
/**
 * This is the extension manager of the Amwayreport extension.
 */
public class AmwayreportManager extends GeneratedAmwayreportManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AmwayreportManager.class);
	 ...
	 */
	public static AmwayreportManager getInstance()
	{
		return (AmwayreportManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwayreportConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmwayreportManager() // NOPMD 
	{
		LOG.debug("constructor of AmwayreportManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AmwayreportManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AmwayreportManager called, current tenant: {}", getTenant().getTenantID());
	}

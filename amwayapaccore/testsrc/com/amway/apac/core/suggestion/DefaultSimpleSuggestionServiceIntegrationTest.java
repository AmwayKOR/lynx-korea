 ...
 */
package com.amway.apac.core.suggestion;
...
import com.amway.apac.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/amwayapaccore/test/testSimpleSuggestionService.csv", "utf-8");
	}

...
public class DefaultAmwayapacstorefrontcomponentsService implements AmwayapacstorefrontcomponentsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAmwayapacstorefrontcomponentsService.class);
	...
	{
		return DefaultAmwayapacstorefrontcomponentsService.class.getResourceAsStream("/amwayapacstorefrontcomponents/sap-hybris-platform.png");
	}

        ...
        config: function(data, conf) {
            ...
            const cmssmartedit = {
                ...
                coverageReporter: {
                    ...
                    dir: 'jsTarget/test/amwayapaccmssmartedit/coverage/',
                    reporters: [{
                        type: 'html',
                        subdir: 'report-html'
                    }, {
                ...
                junitReporter: {
                    outputDir: 'jsTarget/test/amwayapaccmssmartedit/junit/', // results will be saved as $outputDir/$browserName.xml
                ...
                proxies: {
                    '/amwayapaccmssmartedit/images/': '/base/images/'
                },
            ...
            const cmssmarteditContainer = {
                ...
                junitReporter: {
                    outputDir: 'jsTarget/test/amwayapaccmssmarteditContainer/junit/', // results will be saved as $outputDir/$browserName.xml
                    outputFile: 'testReport.xml' // if included, results will be saved as $outputDir/$browserName/$outputFile
                },

...
public class DefaultUpdatePartyPhoneServiceTest extends ServicelayerTest
{
	...
	@Resource(name = "mockUpdatePartyPhoneService")
	private CommonMockService defaultUpdatePartyPhoneServic;
	...
	{
		final CommonResponseFieldsData responce = defaultUpdatePartyPhoneServic.process(requestData);

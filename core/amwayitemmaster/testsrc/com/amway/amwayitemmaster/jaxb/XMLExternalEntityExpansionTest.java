 ...
 *
 */
package com.amway.amwayitemmaster.jaxb;
...
{ AmwayitemmasterConstants.EXTENSIONNAME, "oauth2" })
public class XMLExternalEntityExpansionTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		wsSecuredRequestBuilder = new WsSecuredRequestBuilder()//
				.extensionName(AmwayitemmasterConstants.EXTENSIONNAME)//
				.client(OAUTH_CLIENT_ID, OAUTH_CLIENT_PASS);

		createCoreData();
		importCsv("/amwayitemmaster/test/democustomer-data.impex", "utf-8");
	}

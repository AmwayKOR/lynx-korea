package com.amway.facades.product.impl;
 ...
 */
public class AmwayPriceDataFactory implements PriceDataFactory
{
	...
	private static final Logger LOG = Logger.getLogger(AmwayPriceDataFactory.class);
	...
	protected String formatPrice(final BigDecimal value, final CurrencyModel currency)
	{
		...
		{
			LOG.debug("method: formatPrice, current language: " + currentLanguage.getIsocode());
		}
		...
		if (locale != null)
		{
			LOG.debug("method: formatPrice, current locale: " + locale);
		}
		...
		if (locale == null)
		{
			...
			LOG.debug("method: formatPrice, current fallback locale: " + locale);
		}
	...
	protected NumberFormat createCurrencyFormat(final Locale locale, final CurrencyModel currency)
	{
		...
		LOG.debug("method: createCurrencyFormat, locale key: " + key);

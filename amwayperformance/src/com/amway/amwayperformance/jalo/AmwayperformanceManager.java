 ...
 */
package com.amway.amwayperformance.jalo;
...
/**
 * This is the extension manager of the Amwayperformance extension.
 */
public class AmwayperformanceManager extends GeneratedAmwayperformanceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AmwayperformanceManager.class);
	 ...
	 */
	public static AmwayperformanceManager getInstance()
	{
		return (AmwayperformanceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AmwayperformanceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AmwayperformanceManager() // NOPMD 
	{
		LOG.debug("constructor of AmwayperformanceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AmwayperformanceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AmwayperformanceManager called, current tenant: {}", getTenant().getTenantID());
	}

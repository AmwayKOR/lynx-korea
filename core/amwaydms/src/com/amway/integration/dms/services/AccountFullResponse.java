...
@XmlType(name = "accountFullResponse",
		propOrder = { "aboEntryDate", "aboExpireDate", "aboNum", "accountCreditLimit", "accountCreditStatusCd", "accountId",
				"accountMissingInfoFlg", "accountName", "accountSubTypeCd", "accountTypeCd", "blackListFlg", "busEntityNum",
				"cntryCd", "company", "currencyCd", "includeExcludeFlg", "languageCd", "lateRenewalEligibleFlg", "lglEntityType",
				"loaCd", "orderCreditLimit", "regdSpnIboNo", "regdlntlPrmyBusflg", "regdlntlSpnAffNo", "regdlntlSpnIboNo",
				"salesPlanAff", "segmentCd", "statusCd", "userId", "userPin" })
@JsonIgnoreProperties(ignoreUnknown = true)
public class AccountFullResponse
{

	@XmlElementRef(name = "aboEntryDate",
			type = JAXBElement.class,
			required = false)
	protected String aboEntryDate;
	@XmlElementRef(name = "aboExpireDate",
			type = JAXBElement.class,
			required = false)
	protected String aboExpireDate;
	@XmlElementRef(name = "aboNum",
			type = JAXBElement.class,
			required = false)
	protected String aboNum;
	@XmlElementRef(name = "accountCreditLimit",
			type = JAXBElement.class,
			required = false)
	protected String accountCreditLimit;
	@XmlElementRef(name = "accountCreditStatusCd",
			type = JAXBElement.class,
			required = false)
	protected String accountCreditStatusCd;
	@XmlElementRef(name = "accountId",
			type = JAXBElement.class,
			required = false)
	protected String accountId;
	@XmlElementRef(name = "accountMissingInfoFlg",
			type = JAXBElement.class,
			required = false)
	protected String accountMissingInfoFlg;
	@XmlElementRef(name = "accountName",
			type = JAXBElement.class,
			required = false)
	protected String accountName;
	@XmlElementRef(name = "accountSubTypeCd",
			type = JAXBElement.class,
			required = false)
	protected String accountSubTypeCd;
	@XmlElementRef(name = "accountTypeCd",
			type = JAXBElement.class,
			required = false)
	protected String accountTypeCd;
	@XmlElementRef(name = "blackListFlg",
			type = JAXBElement.class,
			required = false)
	protected String blackListFlg;
	@XmlElementRef(name = "busEntityNum",
			type = JAXBElement.class,
			required = false)
	protected String busEntityNum;
	@XmlElementRef(name = "cntryCd",
			type = JAXBElement.class,
			required = false)
	protected String cntryCd;
	@XmlElementRef(name = "company",
			type = JAXBElement.class,
			required = false)
	protected String company;
	@XmlElementRef(name = "currencyCd",
			type = JAXBElement.class,
			required = false)
	protected String currencyCd;
	@XmlElementRef(name = "includeExcludeFlg",
			type = JAXBElement.class,
			required = false)
	protected String includeExcludeFlg;
	@XmlElementRef(name = "languageCd",
			type = JAXBElement.class,
			required = false)
	protected String languageCd;
	@XmlElementRef(name = "lateRenewalEligibleFlg",
			type = JAXBElement.class,
			required = false)
	protected String lateRenewalEligibleFlg;
	@XmlElementRef(name = "lglEntityType",
			type = JAXBElement.class,
			required = false)
	protected String lglEntityType;
	@XmlElementRef(name = "loaCd",
			type = JAXBElement.class,
			required = false)
	protected String loaCd;
	@XmlElementRef(name = "orderCreditLimit",
			type = JAXBElement.class,
			required = false)
	protected String orderCreditLimit;
	@XmlElementRef(name = "regdSpnIboNo",
			type = JAXBElement.class,
			required = false)
	protected String regdSpnIboNo;
	@XmlElementRef(name = "regdlntlPrmyBusflg",
			type = JAXBElement.class,
			required = false)
	protected String regdlntlPrmyBusflg;
	@XmlElementRef(name = "regdlntlSpnAffNo",
			type = JAXBElement.class,
			required = false)
	protected String regdlntlSpnAffNo;
	@XmlElementRef(name = "regdlntlSpnIboNo",
			type = JAXBElement.class,
			required = false)
	protected String regdlntlSpnIboNo;
	@XmlElementRef(name = "salesPlanAff",
			type = JAXBElement.class,
			required = false)
	protected String salesPlanAff;
	@XmlElementRef(name = "segmentCd",
			type = JAXBElement.class,
			required = false)
	protected String segmentCd;
	@XmlElementRef(name = "statusCd",
			type = JAXBElement.class,
			required = false)

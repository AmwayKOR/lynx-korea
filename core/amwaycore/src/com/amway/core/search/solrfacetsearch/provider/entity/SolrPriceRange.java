...
public class SolrPriceRange
{
	 ...
	 *
	 * @param lower  The {@link SolrPriceRangeEntry} with lower value in the price range.
	 * @param higher The {@link SolrPriceRangeEntry} with higher value in the price range.
	 */
	 ...
	 *
	 * @param solrProperty String that contains the price range property in Solr. See
	...
	public static SolrPriceRange buildSolrPriceRangePairFromProperty(final String solrProperty)
	{
		...
		else
		{
			throw new IllegalArgumentException(
					"The solrProperty [" + solrProperty + "] should have exactly " + (TOKENS - 1) + " separators '" + SEPARATOR + "'");
		}
		return priceRange;
	}
	 ...
	 *
	 * @param minPrice    The lowest price value.
	 * @param minCurrency The currency of the lowest price.
	 * @param maxPrice    The highest price value.
	 * @param maxCurrency The currency of the highest price.

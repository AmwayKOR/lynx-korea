...
/**
 * Populator implementation for {@link CisFieldError} as source and {@link AddressFieldErrorData} as target type.
 */
public class AmwayDMSFieldErrorPopulator implements Populator<List<CisFieldError>, List<AddressFieldErrorData>>
{
	@Override

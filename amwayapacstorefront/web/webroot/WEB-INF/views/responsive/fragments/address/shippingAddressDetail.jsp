...
<span class="secondary-text mailing-address__line-one">${fn:escapeXml(addressData.line1)}&nbsp;<c:if test="${not empty fn:escapeXml(addressData.line2)}">${fn:escapeXml(addressData.line2)}</c:if></span>
<span class="secondary-text mailing-address__city">${fn:escapeXml(addressData.town)}</span>
<div>
    ${fn:escapeXml(addressData.region.name)}
</div>
